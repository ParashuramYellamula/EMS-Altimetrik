...
namespace EMS.API
{
    public class Startup
    {
        ...
        private const string JwtConfigKey = "Jwt:Key";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(options =>
            {
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    ValidIssuer = Configuration[IssuerConfigKey],
                    ValidAudience = Configuration[IssuerConfigKey],
                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(Configuration[JwtConfigKey])),
